...
object ProtoFormatConverterExtensions {
    ...
    private const val TRANSMISSION_RISK_DAY_1 = 5
    private const val TRANSMISSION_RISK_DAY_2 = 6
    private const val TRANSMISSION_RISK_DAY_3 = 8
    private const val TRANSMISSION_RISK_DAY_4 = 8
    private const val TRANSMISSION_RISK_DAY_5 = 8
    private const val TRANSMISSION_RISK_DAY_6 = 5
    private const val TRANSMISSION_RISK_DAY_7 = 3
